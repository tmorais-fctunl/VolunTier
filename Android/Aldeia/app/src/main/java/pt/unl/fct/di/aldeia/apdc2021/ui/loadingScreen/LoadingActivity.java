    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(storage.getLoggedInUser()!=null){
            ...
            if(System.currentTimeMillis()>user.getExpirationDate()){
                if (System.currentTimeMillis()>user.getRefresh_expirationDate()) {
        ...
        viewModel.getLookUpResult().observe(this, new Observer<LookUpResult>() {
            ...
            public void onChanged(@Nullable LookUpResult lookUpResult) {
                ...
                if (lookUpResult.getError() != null) {
                    Toast.makeText(mActivity,"Couldnt connect to server... Check your Internet Connection and try again!",Toast.LENGTH_SHORT).show();
                }
