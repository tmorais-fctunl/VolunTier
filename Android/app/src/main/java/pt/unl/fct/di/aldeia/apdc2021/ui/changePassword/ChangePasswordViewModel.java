...
public class ChangePasswordViewModel extends ViewModel {
    ...
    public void changePassword(String email, String token,String oldPassword,String password,String passwordConfirmation) {
        executor.execute(new Runnable() {
            @Override
            public void run() {
                Result<Void> result = changePasswordRepository.changePassword(email, token,oldPassword,password,passwordConfirmation);
                if (result instanceof Result.Success) {
                    changePasswordResult.postValue(new ChangePasswordResult(R.string.ChangePW_success,null));
                } else {
                    changePasswordResult.postValue(new ChangePasswordResult(null,R.string.ChangePW_failed));
                }
            }
        });
    }
