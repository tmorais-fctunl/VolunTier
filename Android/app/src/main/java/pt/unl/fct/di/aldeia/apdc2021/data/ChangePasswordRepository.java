...
public class ChangePasswordRepository {
    ...
    public Result<Void> changePassword(String email, String token, String oldPassword,String password,String passwordConfirmation) {
        return dataSource.changeProfilePassword(email, token,oldPassword,password,passwordConfirmation);
    }
