...
public class RemoveAccDataSource {
    ...
    public Result<Void> removeUser(String email, String token, String target) {
        Call<Void> tokenValidationCall = service.removeUser(new ProfileTokenCredentials(email, token, target));
        try {
