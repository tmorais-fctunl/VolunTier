...
public class ChangePasswordDataSource {
    ...
    public Result<Void> changeProfilePassword(String email, String token,String target, String oldPassword,String password,String passwordConfirmation) {
        UserChangePassword user= new UserChangePassword(email,token,target,oldPassword,password,passwordConfirmation);
