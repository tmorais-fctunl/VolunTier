<form>
                        <div class="form-group">
                            <div class="flex-nowrap input-group">
                                <div class="input-group-prepend">
                                    <span class="bg-light input-group-text" id="addon-wrapping">
                        ...
                        <div class="form-group">
                            <div class="flex-nowrap input-group">
                                <div class="input-group-prepend">
                                    <span class="bg-light input-group-text" id="addon-wrapping2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
                                            <g>
                        ...
                        <div class="form-group form-check">
                            ...
                            <p>
                                <!--Make sure the check mark makes the password visible-->
                                <input type="checkbox" class="form-check-input" id="exampleCheck1" onclick="showPassword()" />
                                <label class="form-check-label" for="exampleCheck1">Show Password</label>
                            </p>

                        </div>
                        <button type="submit" id="loginButton" class="btn btn-block btn-primary font-weight-bold pb-2 pl-3 pr-3 pt-2" onclick="return login()" disabled="disabled">Sign In</button>
                        <!--Remember to do the forgot password form and password change page for the server to send-->
                        <p style="text-align: center; margin-top: 10px;"><a href="forgotpwd.html" id="forgotpwLink" data-target="forgotpw-box">Forgot password?</a></p>
