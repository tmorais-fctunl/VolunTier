		...
		try {
			...
			if(user != null) {
				...
				user = Entity.newBuilder(userKey)
						...
						.set("user_role", data.getRole().toString())
						.set("user_state", data.getState().toString())
						.set("user_profile", data.profile)
						.set("user_landline", data.landline)
						.set("user_mobile", data.mobile)
						.set("user_address", data.address)
						.set("user_address2", data.address2)
						.set("user_region", data.region)
						.set("user_pc", data.pc)
						.set("user_account", Account.ACTIVE.toString())
						.build();
